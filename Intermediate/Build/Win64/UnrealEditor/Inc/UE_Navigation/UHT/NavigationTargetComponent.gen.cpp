...
struct Z_CompiledInDeferFile_FID_UE_Navigation_Source_UE_Navigation_Public_NavigationTargetComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNavigationTargetComponent, UNavigationTargetComponent::StaticClass, TEXT("UNavigationTargetComponent"), &Z_Registration_Info_UClass_UNavigationTargetComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNavigationTargetComponent), 292672950U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Navigation_Source_UE_Navigation_Public_NavigationTargetComponent_h_395689131(TEXT("/Script/UE_Navigation"),
